...
<Container>
	<section class="col-span-4 lg:col-span-2">
		...
		<div class="section_title my-8 mx-2">
			<h1 class="text-center text-2xl font-bold text-sky-900">VISI DAN MISI</h1>
		</div>
		<div class="m-4">
			<h2>VISI</h2>
			<p>
				Menjadi Universitas Islam sebagai Lokomotif Perubahan Sosial Unggul Nasional Menuju
				Internasional dengan Semangat Moderasi dan Entrepreneurship Islam
			</p>
			<h2>MISI</h2>
			...
			<ol class="mx-8 list-decimal">
				...
				<li>
					...
					pelaksanaan Tri Dharma Perguruan Tinggi serta kesejahteraan civitas akademika.
				</li>
				<li>
					Kepastian evaluasi pelaksanaan SBSN tepat waktu untuk mencapai efektifitas penggunaan
					bangunan.
				</li>
			</ol>
		</div>
	...
	<section class="col-span-4 lg:col-span-2">
		<div id="struktur-organisasi" class="md:h-8" />
		<div class="section_title my-8 mx-2">
			<h1 class="text-center text-2xl font-bold text-sky-900">STRUKTUR ORGANISASI</h1>
			<p class="text-center">dalam pengerjaan</p>
		</div>
		<div class="m-4" />
	</section>
</Container>
